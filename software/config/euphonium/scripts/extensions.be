...
#LS_1_positive - 350Hz
dsp.add_biquad(dsp.CHANNEL_RIGHT, dsp.BIQUAD_TYPE_LOWSHELF, { 'f': real(0.007936507936508), 'g': 1, 'q': 0.7 })
dsp.add_biquad(dsp.CHANNEL_LEFT,  dsp.BIQUAD_TYPE_LOWSHELF, { 'f': real(0.007936507936508), 'g': 1, 'q': 0.7 })
